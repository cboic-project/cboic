...
#if defined(NDEBUG)
# error "Cboic cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Cboic Signed Message:\n";
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Cboic: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Cboic: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
