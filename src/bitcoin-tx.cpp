...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Cboic Core cboic-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cboic-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cboic transaction") + "\n" +
              "  cboic-tx [options] -create [commands]   " + _("Create hex-encoded cboic transaction") + "\n" +
              "\n";
